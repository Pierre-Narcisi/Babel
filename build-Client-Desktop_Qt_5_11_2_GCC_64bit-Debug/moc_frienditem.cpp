...
#include "../QtInterface/frienditem.h"
...
QT_MOC_LITERAL(1, 11, 13), // "onStateChange"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 11), // "FriendItem*"
QT_MOC_LITERAL(4, 38, 2), // "me"
QT_MOC_LITERAL(5, 41, 14), // "onSelectChange"
QT_MOC_LITERAL(6, 56, 8) // "selected"

    },
    "FriendItem\0onStateChange\0\0FriendItem*\0"
    "me\0onSelectChange\0selected"
};
...
void FriendItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onStateChange((*reinterpret_cast< FriendItem*(*)>(_a[1]))); break;
        case 1: _t->onSelectChange((*reinterpret_cast< FriendItem*(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (FriendItem::*)(FriendItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FriendItem::onStateChange)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FriendItem::*)(FriendItem * , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FriendItem::onSelectChange)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FriendItem::onStateChange(FriendItem * _t1)
{
...
// SIGNAL 1
void FriendItem::onSelectChange(FriendItem * _t1, bool _t2)
{
